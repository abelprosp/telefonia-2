    ...
    >
      <div className="flex flex-col gap-4">
        <div className="flex flex-wrap gap-2">
          <Button variant="secondary" size="sm" nativeButton={false} render={<Link to="/stock" search={{ page: 1, pageSize: 10 }} />}>
            Estoque de linhas
          </Button>
          <Button variant="outline" size="sm" nativeButton={false} render={<Link to="/stock/devices" search={{ page: 1, pageSize: 10 }} />}>
