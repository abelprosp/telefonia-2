...
func (s *Service) CreateCustomerBillingDocumentFromReceivable(ctx context.Context, receivableID, templateCode string) (*models.CreateCustomerBillingDocumentFromReceivableResponse, error) {
	orgID, err := orgFrom(ctx)
	if err != nil {
		return nil, err
	}
