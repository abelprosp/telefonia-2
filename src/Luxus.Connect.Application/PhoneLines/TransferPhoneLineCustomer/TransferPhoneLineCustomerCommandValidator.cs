...
internal sealed class TransferPhoneLineCustomerCommandValidator : AbstractValidator<TransferPhoneLineCustomerCommand>
{
    public TransferPhoneLineCustomerCommandValidator()
    {
